...
public partial class Contexts {
    ...
    public void InitializeEntityIndices() {
        game.AddEntityIndex(new Entitas.EntityIndex<GameEntity, string>(
            IndexedEntity,
            game.GetGroup(GameMatcher.IndexedEntity),
            (e, c) => ((IndexedEntityComponent)c).uuid));
    }
}

public static class ContextsExtensions {

    public static System.Collections.Generic.HashSet<GameEntity> GetEntitiesWithIndexedEntity(this GameContext context, string uuid) {
        return ((Entitas.EntityIndex<GameEntity, string>)context.GetEntityIndex(Contexts.IndexedEntity)).GetEntities(uuid);
    }
}
//------------------------------------------------------------------------------
// <auto-generated>
